...
The workspace is already configured. No GitHub account, Supabase account, or server setup is needed to download and use the desktop app.

## First test

Connect your monitors, close private windows, and use the computer normally for 10–15 minutes. The first screenshot is taken at clock-in and follow-ups occur randomly every 5–10 minutes. Take a break, resume, and clock out. Ask your administrator to confirm the timesheet and images from each active monitor.
